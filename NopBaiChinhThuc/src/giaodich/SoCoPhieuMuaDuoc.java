...
public class SoCoPhieuMuaDuoc {
public static void muaGiaTranGiaSan(int soDuTaiKhoan) {
	...
	System.out.println("\n\t+---------------------------------------------+");
	System.out.println("\t|          SO CO PHIEU CO THE MUA DUOC        |");
	System.out.println("\t+---------------------------------------------+\n");
	
	System.out.println("\n+----------------------+");
	System.out.println("|   THEO YEU CAU MOT   |");
	System.out.println("+----------------------+\n");
